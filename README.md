# Learning-QM
Curvature is flattening out coordinates(transforming a metric to a  2D rectilinear flat space, replaced by proper time, otherwise curved).  Tidal forces are an obstruction of gravitational fields(coordinate transformation) in an inertial(accelerated) reference frame. Gravity bends light!..by a factor. The proofs... star-light observation during a solar eclipse, geodesics(tangent vectors), parallel transport(a gyroscope doesn't end in the same vector), abstract Mathematics(gravitational waves),...
...
Here's an alternative online link where the formulas render correctly(MUST login to view or download)...https://drive.google.com/file/d/1fedqISI4dt2mQv6Yi7JW0N55NCdrvewT/view?usp=sharing
